...
export const components: Component[] = [
  { name: "ESP-32 Board", qty: "1PC", icon: "📡", cat: "comunicacion", demo: "/demos/esp32-blink", projects: [
  ...
  { name: "0.96\" OLED Display", qty: "1PC", icon: "🖥️", cat: "display", demo: "/demos/oled-hola-mundo", projects: [
  ...
  { name: "GY-6500 Module", qty: "1PC", icon: "📐", cat: "sensor", demo: "/demos/gy6500-test", projects: [
  ...
  { name: "Power Supply Module", qty: "1PC", icon: "🔌", cat: "electronica", demo: "/demos/power-supply-test", projects: [
  ...
  { name: "ULN2003 + Stepper Motor", qty: "1PC c/u", icon: "⚙️", cat: "motor", demo: "/demos/stepper-test", projects: [
  ...
  { name: "Servo Motor SG90", qty: "1PC", icon: "🦾", cat: "motor", demo: "/demos/servo-test", projects: [
  ...
  { name: "5V Relay", qty: "1PC", icon: "⚡", cat: "control", demo: "/demos/relay-test", projects: [
  ...
  { name: "IR Receiver & Emitter", qty: "1PC c/u", icon: "🔴", cat: "comunicacion", demo: "/demos/ir-test", projects: [
  ...
  { name: "Joystick Module", qty: "1PC", icon: "🕹️", cat: "control", demo: "/demos/joystick-test", projects: [
  ...
  { name: "DHT11 Temp & Humidity", qty: "1PC", icon: "🌡️", cat: "sensor", demo: "/demos/dht11-test", projects: [
  ...
  { name: "Ultrasonic Sensor", qty: "1PC", icon: "📏", cat: "sensor", demo: "/demos/ultrasonic-test", projects: [
  ...
  { name: "Fan + Motor 3-6V", qty: "1PC", icon: "🌀", cat: "motor", demo: "/demos/fan-motor-test", projects: [
  ...
  { name: "HC-SR501 PIR Sensor", qty: "1PC", icon: "👁️", cat: "sensor", projects: [
  ...
  { name: "Membrane Switch Keypad", qty: "1PC", icon: "⌨️", cat: "control", projects: [
  ...
  { name: "Button + Potenciómetro", qty: "5 / 1PC", icon: "🔘", cat: "control", projects: [
  ...
  { name: "7-Segment Display", qty: "1 + 4 dígitos", icon: "🔢", cat: "display", projects: [
  ...
  { name: "Tilt Ball Switch", qty: "1PC", icon: "⚖️", cat: "sensor", projects: [
  ...
  { name: "Remote Control", qty: "1PC", icon: "📺", cat: "comunicacion", projects: [
  ...
  { name: "Resistores, LEDs, RGB", qty: "120 / 25 / 2PCS", icon: "💡", cat: "electronica", projects: [
  ...
  { name: "Photoresistor (LDR)", qty: "2PCS", icon: "☀️", cat: "sensor", projects: [
  ...
  { name: "NPN Transistor PN2222", qty: "2PCS", icon: "🔁", cat: "electronica", projects: [
  ...
  { name: "Thermistor", qty: "1PC", icon: "🌡️", cat: "sensor", projects: [
  ...
  { name: "9V Battery + Clip", qty: "1PC", icon: "🔋", cat: "electronica", projects: [
